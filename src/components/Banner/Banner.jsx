          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                <p
                  data-aos="fade-up"
                  className="text-sm text-gray-400 tracking-wide leading-8"
                >
                We believe in satisfying travel dreams that make you perpetually rich in experiences. Through our cutting-edge designed holiday packages and essential travel services, we’ve been creating memorable journeys for years.
                  <br />
                </p>
